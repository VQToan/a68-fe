...
export const getAll = async (
  ...
  const response = await apiClient.get(
    `api/v1/trading-accounts?${params.toString()}`
  );
...
export const getAccountSummary = async (
  ...
  const response = await apiClient.get(
    `api/v1/trading-accounts/${accountId}/summary`
  );
  return response.data;
};
...
export const refreshAccountData = async (
  ...
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/refresh`
  );
  return response.data;
};
...
export const getAccountBalance = async (
  ...
  const response = await apiClient.get(
    `api/v1/trading-accounts/${accountId}/balance`
  );
  return response.data;
};
...
export const getSpotBalance = async (
  accountId: string
): Promise<SpotBalanceResponse> => {
  const response = await apiClient.get(
    `api/v1/trading-accounts/${accountId}/spot/balance`
  );
  return response.data;
};
...
export const getPositions = async (
  ...
  const url = `api/v1/trading-accounts/${accountId}/positions${
...
export const openPosition = async (
  ...
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/positions/open`,
    data
  );
  return response.data;
};
...
export const closePosition = async (
  ...
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/positions/close`,
    data
  );
  return response.data;
};

export const closePartialPosition = async (
  accountId: string,
  data: ClosePartialPositionRequest
): Promise<ClosePartialPositionResponse> => {
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/positions/close-partial`,
    data
  );
  return response.data;
};
...
export const getOpenOrders = async (
  ...
  const queryString = params.toString();
  const url = `api/v1/trading-accounts/${accountId}/orders/open${
    queryString ? `?${queryString}` : ""
  }`;
...
): Promise<TakeProfitStopLossResponse> => {
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/orders/take-profit`,
    data
  );
  return response.data;
};
...
export const placeStopLoss = async (
  ...
  const response = await apiClient.post(
    `api/v1/trading-accounts/${accountId}/orders/stop-loss`,
    data
  );
  return response.data;
};
...
export const cancelOrder = async (
  ...
  orderId: number,
  symbol: string
): Promise<CancelOrderByIdResponse> => {
  const params = new URLSearchParams();
  params.append("symbol", symbol);

  const response = await apiClient.delete(
    `api/v1/trading-accounts/${accountId}/orders/${orderId}?${params.toString()}`
  );
  return response.data;
};
...
export const cancelAllOrders = async (
  ...
  const response = await apiClient.delete(
    `api/v1/trading-accounts/${accountId}/orders?${params.toString()}`
  );
  return response.data;
};
